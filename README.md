...
[![Release: v0.2.1](https://img.shields.io/badge/release-v0.2.1-blue?style=flat-square)](https://github.com/mindicator/invairiant/releases/latest)
...
**v0.2.1.** The protocol layer — docs, 28 lenses, templates, schemas,
...
PR, commit range, single commit, module, ADR↔code drift, refactoring proposal —
over the same pipeline, each `collect --scope …` failing closed rather than
widening, and **still no new lenses**. What's next (PyPI, Marketplace, more case
